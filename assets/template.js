...
$( document ).ready(function() {
    ...
    var para_keys = ["ap_1", "resist"]

    var umap_labels = ["dandiset label", "species", "GMM cluster label", "brain_region"]
    ...
    generate_umap(data_tb, ['Umap X', 'Umap Y', 'dandiset label']); 
 	var paracoordskeys = ['ap_1', 'resist'];
                    var paracoordscolors = "ap_1_width_0_long_square";
                    generate_paracoords(data_tb, ['ap_1', 'resist'], 'ap_1_width_0_long_square'); 
